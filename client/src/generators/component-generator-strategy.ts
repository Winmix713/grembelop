...
import { ComponentConfig, GeneratedComponent, AccessibilityReport, ResponsiveBreakpoints, ComponentMetadata } from '../types/figma-generator';
import { TemplateEngine } from '../utils/template-engine';
import { CodeGenerationError } from '../utils/errors';
...
@media (min-width: 1025px) {
  ...
  private analyzeAccessibilityIssues(config: ComponentConfig): any[] {
  ...
  private calculateAccessibilityScore(config: ComponentConfig, issues: any[]): number {
